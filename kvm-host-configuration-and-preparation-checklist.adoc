...
---
= Prepara un host KVM para ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
+
Instala el sistema operativo RHEL usando la imagen ISO. Consulta el link:reference_plan_ots_hardware.html#software-compatibility["información de compatibilidad de software para hipervisores"] para ver una lista de las versiones de RHEL compatibles. Durante la instalación, configura el sistema de la siguiente manera:
...
+
Para más información sobre los paquetes necesarios y otros requisitos de configuración, consulta la link:https://imt.netapp.com/matrix/#welcome["Herramienta de matriz de interoperabilidad"^].
