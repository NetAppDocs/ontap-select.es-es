...
La utilidad de administración de implementación contiene una sola versión de ONTAP Select. Si desea implementar los clústeres mediante una versión anterior de ONTAP Select, primero debe añadir la imagen de ONTAP Select a la instancia de implementación. Consulte link:task_adm_deploy_image_add.html["Adición de una imagen de ONTAP Select para implementar"] si quiere más información.
