...
Antes de implementar un clúster de ONTAP Select en un entorno de producción, debe adquirir una licencia de capacidad de almacenamiento y descargar el archivo de licencia asociado. Puede utilizar la licencia para el almacenamiento en cada nodo utilizando el modelo _Capacity Tiers_ o disponer de una licencia para un pool compartido utilizando el modelo _Capacity Pools_.
...
.Antes de empezar
Debe tener la información de configuración del nodo. El archivo de licencia de nivel de capacidad debe cargarse e instalarse en la utilidad Deploy.
