...
---
= Mejoras en la protección de datos con ONTAP Select HA
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: La arquitectura de buzón y el método de latido basado en disco para resolver los problemas de quórum del clúster y de cerebro dividido son las razones por las que la variante multinodo de ONTAP Select requiere cuatro nodos separados o un mediador para un clúster de dos nodos.
