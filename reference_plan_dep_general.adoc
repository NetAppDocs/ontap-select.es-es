...
* *Host*: Se utiliza para autenticar un host hipervisor como parte de la implementación de un nodo ONTAP Select directamente en VMware ESXi
* *vCenter*: se utiliza para autenticar un servidor vCenter como parte de la implementación de un nodo ONTAP Select en ESXi cuando el host está gestionado por VMware vCenter
