...
---
= Actualiza los nodos de ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Actualiza el nodo ONTAP Select usando los procedimientos estándar de actualización de ONTAP con el archivo de actualización de ONTAP Select. Para información sobre las rutas de actualización compatibles, consulta el link:https://docs.netapp.com/us-en/ontap/upgrade/concept_upgrade_paths.html["Rutas de actualización de ONTAP admitidas"^].
