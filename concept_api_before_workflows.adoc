...
---
= Infórmate sobre cómo usar los flujos de trabajo de la API de ONTAP Select Deploy
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* Categoría Las llamadas API están organizadas en la página de documentación en áreas o categorías relacionadas funcionalmente. Para localizar una llamada API específica, desplázate hasta la parte inferior de la página y selecciona la categoría API aplicable.
