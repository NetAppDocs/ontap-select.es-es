...
.Antes de empezar
Has revisado la link:kvm-host-configuration-and-preparation-checklist.html["lista de comprobación previa a la instalación"].
...
.. Escribe la contraseña y selecciona *Intro*.
.. Espere hasta que aparezca el siguiente símbolo del sistema:
+
