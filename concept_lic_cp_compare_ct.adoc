...
---
= Comparativa de licencias de ONTAP Select Capacity Tiers y Capacity Pools
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
| Licencia mínima | 1 TB | 2 TB 


| Espacio gestionado máximo | 400 TB por nodo | 400 TB por nodo 
|===