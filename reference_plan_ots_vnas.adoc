...
---
= Requisitos de almacenamiento externo de VMware ESXi para ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Revisa la documentación de VMware y sigue las mejores prácticas aplicables identificadas para hosts ESXi. Además:
...
* Verifica que todas las matrices de almacenamiento externo genérico usen las funciones de redundancia y HA disponibles siempre que sea posible
