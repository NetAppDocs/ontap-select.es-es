...
[role="lead"]
Puedes proteger una implementación de ONTAP Select cambiando la contraseña de la cuenta de administrador de la máquina virtual Deploy según sea necesario mediante la interfaz de línea de comandos.
