...
ONTAP Select es compatible con modelos de CPU basados en procesadores Intel Xeon Sandy Bridge y Advanced Micro Devices (AMD).

Consulta la  https://mysupport.netapp.com/matrix["Herramienta de matriz de interoperabilidad"^] para más información.
...
.Procesador
Entre los microprocesadores compatibles se encuentran los procesadores Intel Xeon para servidores y los procesadores AMD.

Consulta link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Procesadores Intel Xeon"^] y link:https://www.amd.com/en/products/processors/server/epyc.html["CPU de servidor AMD EPYC"^] para más información.
...
Más información link:concept_lic_platforms.html["las ofertas de licencias de plataforma para ONTAP Select"]
