...
NOTE: ONTAP Select admite todas las cabinas de almacenamiento externo descritas en la guía de compatibilidad de almacenamiento/SAN de VMware, incluidos iSCSI, Fibre Channel y Fibre Channel sobre Ethernet.
