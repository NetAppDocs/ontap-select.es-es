...
* link:reference_lic_ontap_features.html#ontap-features-automatically-enabled-by-default["Conozca las funciones de ONTAP habilitadas de forma predeterminada"]
