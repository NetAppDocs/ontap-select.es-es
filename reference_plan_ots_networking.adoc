...
---
= Requisitos de red de ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Para obtener más información sobre cómo configurar un vSwitch en un host hipervisor y la función de interfaz de alta velocidad, consulta la sección link:concept_nw_concepts_chars.html["Redes profundas"].
...
Consulta la sección link:concept_nw_concepts_chars.html["Redes profundas"] para más información sobre las implementaciones de dos NIC.
...
Consulta la sección link:concept_nw_concepts_chars.html["Redes profundas"] para más información sobre las implementaciones de cuatro NIC.
