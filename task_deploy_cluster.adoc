...
---
= Implementa un clúster de ONTAP Select usando la interfaz web
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Pasos
Los pasos a seguir dependen de si desea crear un clúster de un solo nodo o de varios nodos. Un clúster multinodo puede tener dos, cuatro, seis, ocho, diez o doce nodos.
