...
Tras implementar el clúster, confirme que la función ONTAP Select AutoSupport esté configurada y luegolink:task_cli_clusters.html["Realizar una copia de seguridad de los datos de configuración de ONTAP Select Deploy"] .
