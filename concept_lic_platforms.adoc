...
.3+| Unidades de estado sólido (SSD) en un... | Configuración RAID de hardware | No | Sí | Sí 
...
*Nota*: Existen limitaciones de flujo de trabajo RAID por software para hipervisores KVM en RHEL 10.1 y 10.0 y Rocky Linux 10.0. Para más información, consulta los siguientes artículos de la base de conocimientos:
...
====
.¿Que sigue?
link:concept_lic_workflow.html["Conoce cómo comprar una licencia de ONTAP Select"]
