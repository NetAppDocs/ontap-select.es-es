...
---
= Ofertas de licencias de plataforma para ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
La siguiente tabla compara las capacidades de las ofertas de licencias estándar, premium y premium XL.

[cols="25,25,25,25,25"]
|===
2+| La licencia admite... | Estándar | Premium | Premium XL 


2+| Tipo de instancia | Sólo pequeño | Pequeño o mediano | Pequeño, mediano o grande 


.2+| Unidades de disco duro (HDD) en un... | Configuración RAID de hardware | Sí | Sí | Sí 


| configuración de vNAS | Sí | Sí | Sí 


.3+| Unidades de estado sólido (SSDs) en ... | Configuración RAID de hardware | No | Sí | Sí 


| Configuración RAID de software | No | Sí | Sí 


| configuración de vNAS | Sí | Sí | Sí 


.3+| Unidades NVMe en un... | Configuración RAID de hardware | No | No | Sí 


| Configuración RAID de software | No | No | Sí 
...
Las ofertas de licencias estándar, premium y premium XL son compatibles con una amplia gama de hardware y software. Para información actual sobre las versiones de hardware y software, consulta la link:https://mysupport.netapp.com/matrix/["Herramienta de matriz de interoperabilidad"^].
...
2+| Opciones de puesta en marcha 3+| Nodo único. Clúster de dos nodos (par HA). Clúster de cuatro, seis, ocho, diez o doce nodos. 
...
2+| Familia CPU  a| 
Intel Xeon E5-26xx v3 (Haswell) o posterior

AMD EPYC Embedded 9004 o posterior y 8004
 a| 
Intel Xeon E5-26xx v3 (Haswell) o posterior
...
2+| Red (por nodo) 3+| Se requiere un mínimo de dos puertos 1GbE para un clúster de un solo nodo. Se requiere un mínimo de cuatro puertos 1GbE para un clúster de dos nodos (par HA). Se requiere un mínimo de dos puertos 10GbE para un clúster de cuatro, seis, ocho, diez o doce nodos. 
|===
...
2+| Soporte del hipervisor (VMware) 3+| VMware vSphere 9.0, VMware vSphere 8.0GA y actualizaciones 1 a 3, VMware vSphere 7.0GA y actualizaciones 1 a 3C. 


2+| Soporte del hipervisor (KVM)  a| 
Red Hat Enterprise Linux 64-bit (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.8, 8.7 y 8.6

Rocky Linux (KVM) 10.1, 10.0, 9.7, 9.6, 9.5, 9.4, 9.3, 9.2, 9.1, 9.0, 8.9, 8.8, 8.7 y 8.6
...
====
.¿Que sigue?
Más información link:concept_lic_workflow.html["compra de una licencia ONTAP Select"]
