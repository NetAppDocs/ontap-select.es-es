...
. Selecciona la pestaña *Cluster* en la parte superior de la página, luego selecciona el cluster deseado de la lista.
. En la página de detalles del clúster, selecciona el icono de engranaje a la derecha de la página y selecciona *Redimensionar instancia*.
. Selecciona el *Tipo de instancia* e introduce las credenciales de ONTAP, luego selecciona *Modificar*.
