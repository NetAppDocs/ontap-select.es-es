...
---
= Infórmate sobre cómo acceder a la API de ONTAP Select Deploy
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: La API de REST incluida con ONTAP Select Deploy tiene asignado un número de versión. El número de versión de la API es independiente del número de versión de Deploy. La utilidad de administración de ONTAP Select 9.19.1 Deploy incluye la versión 3 de la API de REST.
