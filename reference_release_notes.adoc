...
Puede acceder a https://library.netapp.com/ecm/ecm_download_file/ECMLP3330673["Notas de la versión de ONTAP Select 9.16.1"^] para ver los detalles de la versión actual.
