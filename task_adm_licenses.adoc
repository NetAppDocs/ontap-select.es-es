...
. Opcionalmente, selecciona *Filtro* para limitar las licencias mostradas.
...
Para obtener más información sobre ONTAP Select y la renovación de licencias, consulta la sección Licencias, instalación, actualizaciones y reversiones en el link:reference_faq.html#licenses-installation-upgrades-and-reverts["PREGUNTAS FRECUENTES"].
