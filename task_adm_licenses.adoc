...
== Gestión de las licencias de nivel de capacidad
...
== Permite gestionar las licencias de pool de capacidad
...
== Volver a instalar una licencia de pool de capacidad
...
== Conversión de una licencia de evaluación a una licencia de producción
...
.Antes de empezar
* Debe utilizar ONTAP Select 9.5P1 con Deploy 2.11 o posterior
...
== Gestionar una licencia de pool de capacidad caducada
