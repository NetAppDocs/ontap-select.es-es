...
---
= Flujo de compra de licencias para ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Sitio Web de licencias:: Obtienes una licencia de Capacity Tier y una de Capacity Pool en sitios web diferentes.
...
.¿Que sigue?
Conoce las consideraciones para dimensionar una licencia de ONTAP Select:

* link:sizing-capacity-tier-license.html["Licencia Capacity Tiers"]
* link:sizing-capacity-pool-license.html["Licencia de Capacity Pools"]


.Información relacionada
link:task_adm_licenses.html["Conoce cómo gestionar las licencias de ONTAP Select"]
