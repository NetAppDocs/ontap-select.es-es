...
summary: Puede usar el siguiente script para cambiar el tamaño de los nodos de un clúster de ONTAP Select. 
---
= Script para cambiar el tamaño de los nodos del cluster ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
