...
Soporte para la gestión externa de claves (KMIP):: A partir de ONTAP Select 9.19.1, ONTAP Select admite la gestión externa de claves mediante el protocolo de interoperabilidad de gestión de claves (KMIP). Puedes activar la gestión externa de claves después de desplegar un clúster de ONTAP Select 9.19.1 o de actualizar un clúster existente a ONTAP Select 9.19.1. La gestión externa de claves es la única gestión de claves que admite ONTAP Select 9.19.1. Para más información, consulta link:reference_lic_ontap_features.html#licensed-ontap-features["Funciones de ONTAP con licencia por defecto"].
+
--
ONTAP Select no es compatible con gestores de claves en la nube ni con el ONTAP Onboard Key Manager.
...
--
Soporte para SnapMirror cloud:: A partir de ONTAP Select 9.17.1, SnapMirror cloud es compatible con ONTAP Select. SnapMirror cloud es una función de ONTAP con licencia que se activa por defecto cuando implementas un clúster de ONTAP Select 9.17.1 o actualizas un clúster de ONTAP Select existente a la versión 9.17.1.
+
--
https://docs.netapp.com/us-en/ontap/concepts/snapmirror-cloud-backups-object-store-concept.html["Conoce las copias de seguridad en la nube de SnapMirror a almacenamiento de objetos"^].

--
Compatibilidad con SnapLock Select:: A partir de ONTAP Select 9.17.1, las nuevas implementaciones tienen SnapLock Select (incluido el bloqueo de snapshots a prueba de manipulaciones) licenciado automáticamente. Para actualizaciones desde ONTAP Select 9.16.1 y anteriores, puedes descargar la licencia SnapLock Select gratis desde link:https://mysupport.netapp.com/site/["Sitio de soporte de NetApp"^] y aplicarla manualmente. Para obtener más información, consulta link:reference_lic_ontap_features.html#licensed-ontap-features["Funciones de ONTAP con licencia por defecto"].
