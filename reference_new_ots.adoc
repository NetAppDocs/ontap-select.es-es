...
NOTE: Los cambios en la descarga del producto también se aplican a ONTAP Select 9.17.1, 9.16.1, 9.15.1 y 9.14.1.
...
--
Compatibilidad con SnapLock Select Enterprise:: A partir de ONTAP Select 9.17.1, las nuevas implementaciones tienen licencia automática para SnapLock Select Enterprise (incluido el bloqueo de instantáneas a prueba de manipulaciones).  Para las actualizaciones de ONTAP Select 9.16.1 y anteriores, debe descargar la licencia de SnapLock Select desdelink:https://mysupport.netapp.com/site/["Sitio de soporte de NetApp"^] y aplicarlo manualmente.
