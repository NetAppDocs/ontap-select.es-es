...
--
Compatibilidad actualizada con hipervisor de KVM:: A partir de ONTAP Select 9.17.1, el hipervisor KVM es compatible con Red Hat Enterprise Linux (RHEL) 10.0 y 9.6 y Rocky Linux 10.0 y 9.6.
+
--
[NOTE]
====
