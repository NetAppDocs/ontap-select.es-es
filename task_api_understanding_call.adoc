...
.Pasos
. En la página principal, desplázate hasta la parte inferior y selecciona *Cluster*.
. Selecciona *GET /clusters/{cluster_id}* para mostrar los detalles de la llamada a la API utilizada para devolver información sobre un cluster de ONTAP Select.
