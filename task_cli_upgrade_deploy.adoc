...
Puedes actualizar directamente a ONTAP Select Deploy 9.18.1 desde ONTAP Select Deploy 9.17.1 o 9.16.1. Para actualizar desde una versión anterior, por ejemplo, ONTAP Select Deploy 9.15.1, primero tienes que actualizar a ONTAP Select Deploy 9.16.1 o 9.17.1 y luego actualizar a ONTAP Select Deploy 9.18.1.
...
====
.Antes de empezar
Verifica que ONTAP Select Deploy no se use para realizar ninguna otra tarea durante la actualización.
