...
Puedes actualizar directamente a ONTAP Select Deploy 9.19.1 desde ONTAP Select Deploy 9.18.1 o 9.17.1. Para actualizar desde una versión anterior, por ejemplo, ONTAP Select Deploy 9.16.1, primero tienes que actualizar a ONTAP Select Deploy 9.17.1 o 9.18.1 y luego actualizar a ONTAP Select Deploy 9.19.1.

[NOTE]
====
Si tienes instalada una versión anterior de la utilidad de administración ONTAP Select Deploy, deberías actualizar a la versión actual. Actualizas los componentes ONTAP Select node y ONTAP Select Deploy de forma independiente. Consulta link:concept_adm_upgrading_nodes.html["Actualice los nodos ONTAP Select"^] para más detalles.
