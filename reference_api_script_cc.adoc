...
summary: Puede utilizar el siguiente script para crear un clúster basado en los parámetros definidos en el script y en un archivo de entrada JSON. 
---
= Script para crear un cluster de ONTAP Select
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
