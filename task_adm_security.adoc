...
. Selecciona el icono de la figura en la parte superior derecha de la página y luego selecciona *Cambiar contraseña*.
. Proporciona la contraseña actual y la nueva cuando se te pida y selecciona *Submit*.
...
. Selecciona *Management Servers* > *Add vCenter*.
. Ingresa la siguiente información y selecciona *Add*.
+
[cols="30,70"]
|===
...
|===
. Opcionalmente, selecciona image:icon_kebab.gif["Opciones"] después de añadir el nuevo servidor de gestión, luego selecciona una de las siguientes:
+
